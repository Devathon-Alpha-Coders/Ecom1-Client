import { FIREBASE_ERROR_CODES } from "@shared/constants";
...
export const extractErrorMessage = (
    ...
    if (err instanceof FirebaseError) {
        message = FIREBASE_ERROR_CODES.auth.find(el => el.code === err.code)?.message || FIREBASE_ERROR_CODES.defaultMessage;
    } else if (
        typeof err === 'object' &&
        err !== null &&
        'response' in err &&
