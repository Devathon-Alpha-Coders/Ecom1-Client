...
const CartItem = (props: CartItemProps) => {
  const { name, product_id, price, quantity } = props.item
      ...
      <div className="relative flex flex-1 flex-col justify-between">
        <div className="sm:col-gap-5 sm:grid sm:grid-cols-2">
          <div className="pr-8 sm:pr-5">
            ...
            <p className="mx-0 mt-1 mb-0 text-sm text-gray-400">{product_id}</p>
          </div>
...
interface ICartDetailsProps {
  ...
  removeFromCart: (productId: IGetMultipleProductItem['id']) => void
  removeAllFromCart: (productId: IGetMultipleProductItem['id']) => void
  clearCart: () => void
}

const CartDetails = (props: ICartDetailsProps) => {
  const {
    cartItems,
    addToCart,
    removeFromCart,
    ...
    <section className=" bg-gray-100 py-12 sm:py-16 lg:py-20">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="text-gray-500 text-sm">4 Items</div>
          <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Clear Cart</button>
        </div>
